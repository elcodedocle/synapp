...
INSERT INTO `images` (`id`, `name`, `collectionid`, `uploader`) VALUES
  ('test10A.jpg', 'default group A test image 10', 1, 'defaultadminuser'),
  ('test10B.jpg', 'default group B test image 10', 2, 'defaultadminuser'),
  ('test11A.jpg', 'default group A test image 11', 1, 'defaultadminuser'),
  ('test11B.jpg', 'default group B test image 11', 2, 'defaultadminuser'),
  ('test12A.jpg', 'default group A test image 12', 1, 'defaultadminuser'),
  ('test12B.jpg', 'default group B test image 12', 2, 'defaultadminuser'),
  ('test13A.jpg', 'default group A test image 13', 1, 'defaultadminuser'),
  ('test13B.jpg', 'default group B test image 13', 2, 'defaultadminuser'),
  ('test14A.jpg', 'default group A test image 14', 1, 'defaultadminuser'),
  ('test14B.jpg', 'default group B test image 14', 2, 'defaultadminuser'),
  ('test15A.jpg', 'default group A test image 15', 1, 'defaultadminuser'),
  ('test15B.jpg', 'default group B test image 15', 2, 'defaultadminuser'),
  ('test1A.jpg', 'default group A test image 1', 1, 'defaultadminuser'),
  ('test1B.jpg', 'default group B test image 1', 2, 'defaultadminuser'),
  ('test2A.jpg', 'default group A test image 2', 1, 'defaultadminuser'),
  ('test2B.jpg', 'default group B test image 2', 2, 'defaultadminuser'),
  ('test3A.jpg', 'default group A test image 3', 1, 'defaultadminuser'),
  ('test3B.jpg', 'default group B test image 3', 2, 'defaultadminuser'),
  ('test4A.jpg', 'default group A test image 4', 1, 'defaultadminuser'),
  ('test4B.jpg', 'default group B test image 4', 2, 'defaultadminuser'),
  ('test5A.jpg', 'default group A test image 5', 1, 'defaultadminuser'),
  ('test5B.jpg', 'default group B test image 5', 2, 'defaultadminuser'),
  ('test6A.jpg', 'default group A test image 6', 1, 'defaultadminuser'),
  ('test6B.jpg', 'default group B test image 6', 2, 'defaultadminuser'),
  ('test7A.jpg', 'default group A test image 7', 1, 'defaultadminuser'),
  ('test7B.jpg', 'default group B test image 7', 2, 'defaultadminuser'),
  ('test8A.jpg', 'default group A test image 8', 1, 'defaultadminuser'),
  ('test8B.jpg', 'default group B test image 8', 2, 'defaultadminuser'),
  ('test9A.jpg', 'default group A test image 9', 1, 'defaultadminuser'),
  ('test9B.jpg', 'default group B test image 9', 2, 'defaultadminuser');
